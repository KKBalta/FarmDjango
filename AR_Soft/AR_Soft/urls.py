"""
URL configuration for AR_Soft project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="Farm Django API",
        default_version='v1',
        description="API documentation for Farm Django application",
...
urlpatterns = [
    ...
    # Using custom login view with email authentication
